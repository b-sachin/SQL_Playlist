...
Create table Temperature (id integer, record_date date, temp float);
insert into Temperature values
(1,'2015-01-01',10.00),(2,'2015-01-02',25.00),
(3,'2015-01-03',20.00),(4,'2015-01-04',30.00);

Create table secretsanta(color varchar(45), name varchar(45), colourAssigned varchar(45));

insert into secretsanta values('red','david','blue'), ('blue','Sudha','Yellow'),
('black','sunil','pink'),('yellow','sushant','red'),('pink','Sam','Green'),('green','durva','black');

create table myclass_1(s_id integer, s_name varchar(66), age integer);
insert into myclass_1 values (1,'Tom',27),(2,'Peter',66),(3,'Rehan',75),(4,'Drake',55);

create table myclass_2(s_id integer, s_name varchar(66), age integer);
insert into myclass_2 values (4,'Drake',55),(5,'Sally',45),(6,'Jerry',75),(7,'Mike',55);
...
use `new excelr batch 16`;
Create Table customers(customerID Integer PRIMARY Key, Customer Varchar(111));
INSERT INTO Customers (CustomerID, Customer) VALUES
(1, 'Alice Johnson'),
(2, 'Bob Smith'),
(3, 'Carol Taylor'),
(4, 'David Brown'),
...
(30, 'Diana Mitchell');
 ...
 Create table Product_Sold(ProductID integer PRIMARY KEY,Product Varchar(111),Customer_ID Integer,
 FOREIGN KEY(customer_id) REFERENCES customers(customerID));

INSERT INTO Product_sold (ProductID, Product, Customer_ID) VALUES
(101, 'Stainless Steel Toaster', 1),
(102, 'Electric Coffee Grinder', 1),
(103, 'Microwave Oven', 3),
(104, 'Dishwasher', 4),
(105, 'Electric Kettle', 5),
(106, 'Blender', 6),
(107, 'Slow Cooker', 7),
(108, 'Food Processor', 3),
(109, 'Rice Cooker', 9),
(110, 'Juicer', 10),
(111, 'Hand Mixer', 3),
(112, 'Stand Mixer', 12),
(113, 'Espresso Machine', 13),
(114, 'Air Fryer', 14),
(115, 'Deep Fryer', 3),
(116, 'Sandwich Maker', 16),
(117, 'Ice Cream Maker', 4),
(118, 'Induction Cooktop', 18),
(119, 'Countertop Oven', 19),
(120, 'Bread Maker', 4),
(121, 'Portable Grill', 21),
(122, 'Steam Oven', 22),
(123, 'Popcorn Maker', 23),
(124, 'Waffle Maker', 24),
(125, 'Sous Vide Precision Cooker', 25),
(126, 'Electric Skillet', 1),
(127, 'Tea Maker', 3),
(128, 'Hot Water Dispenser', 28),
(129, 'Convection Oven', 29),
(130, 'Chocolate Fountain', 3),
(131, 'Multi-Cooker', 1),
(132, 'Herb Infuser', 4),
(133, 'Nutrition Scale', 3),
(134, 'Yogurt Maker', 4),
(135, 'Vacuum Sealer', 5),
(136, 'Soda Maker', 6),
(137, 'Electric Steamer', 7),
(138, 'Spice Grinder', 8),
(139, 'Food Dehydrator', 9),
(140, 'Pasta Maker', 10),
(141, 'Rotisserie Oven', 11),
(142, 'Vegetable Chopper', 12),
(143, 'Pizza Oven', 13),
(144, 'Garbage Disposal', 14),
(145, 'Compact Refrigerator', 15),
(146, 'Egg Cooker', 3),
(147, 'Ice Maker', 1),
(148, 'Range Hood', 18),
(149, 'Wine Cooler', 4),
(150, 'Pressure Cooker', 9);
